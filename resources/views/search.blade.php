            ...
            <div class="flex justify-between items-center py-4">
                ...
                <div class="flex items-center space-x-3">
                    @auth
                        ...
                        <a href="{{ route('landing') }}" class="text-red-500 font-inter font-semibold hover:text-red-600 transition-colors">&lt; Back</a>
                    @else
                        <!-- Guest user -->
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="flex flex-col lg:flex-row gap-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','duration']), ['duration' => '2jam+'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','duration']), ['duration' => '1jam'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','duration']), ['duration' => '30menit'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','duration']), ['duration' => 'express'])) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','category']), ['category' => 'masakan-utama'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','category']), ['category' => 'minuman'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','category']), ['category' => 'sea-food'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','category']), ['category' => 'dessert'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','category']), ['category' => 'sup-kuah'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','category']), ['category' => 'cemilan'])) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','budget']), ['budget' => '100k+'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','budget']), ['budget' => '50-100k'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','budget']), ['budget' => '30-50k'])) }}"
                           ...
                           <a href="{{ route('search', array_merge(request()->except(['page','budget']), ['budget' => '15-30k'])) }}"
                    ...
                    <div class="mb-8">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','nutrition']), ['nutrition' => 'karbohidrat'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','nutrition']), ['nutrition' => 'protein'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','nutrition']), ['nutrition' => 'lemak'])) }}"
                            ...
                            <a href="{{ route('search', array_merge(request()->except(['page','nutrition']), ['nutrition' => 'mineral'])) }}"
            ...
            <div class="lg:w-3/4">
                ...
                @php
                    $hasActiveFilters = request()->hasAny(['duration','category','budget','nutrition','allergen']);
                    $durationLabels = [
                        'express' => 'Express',
                        '30menit' => '30 Menit',
                        '1jam' => '1 Jam',
                    ...
                    <div class="mb-6">
                        <div class="bg-white rounded-lg shadow-sm p-4">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <a href="{{ route('search', request()->only('search')) }}" class="text-sm text-red-500 hover:text-red-600 font-medium">Hapus Semua</a>
                            </div>
                            <div class="flex flex-wrap gap-2">
                                @if (request('duration'))
                                    <a href="{{ route('search', request()->except('duration')) }}" class="bg-pink-100 text-pink-800 px-3 py-1 rounded-full text-sm hover:bg-pink-200 transition-colors">
                                        Durasi: {{ $durationLabels[request('duration')] ?? request('duration') }}
                                    </a>
                                @endif
                                @if (request('category'))
                                    <a href="{{ route('search', request()->except('category')) }}" class="bg-pink-100 text-pink-800 px-3 py-1 rounded-full text-sm hover:bg-pink-200 transition-colors">
                                        Kategori: {{ $categoryLabels[request('category')] ?? request('category') }}
                                    </a>
                                @endif
                                @if (request('budget'))
                                    <a href="{{ route('search', request()->except('budget')) }}" class="bg-pink-100 text-pink-800 px-3 py-1 rounded-full text-sm hover:bg-pink-200 transition-colors">
                                        Budget: {{ $budgetLabels[request('budget')] ?? request('budget') }}
                                    </a>
                                @endif
                                @if (request('nutrition'))
                                    <a href="{{ route('search', request()->except('nutrition')) }}" class="bg-pink-100 text-pink-800 px-3 py-1 rounded-full text-sm hover:bg-pink-200 transition-colors">
                                        Gizi: {{ $nutritionLabels[request('nutrition')] ?? request('nutrition') }}
                                    </a>
                                @endif
                                {{-- Alergen filter removed from UI --}}
                            </div>
                        </div>
                    </div>
                @endif
